...
![image]({static}terrain-easygen/Image28.gif)
...
und dann in dem Texturenfenster auf den lila Shader `caulk` ![image]({static}terrain-easygen/gtk/Image27.gif).
...
![image]({static}terrain-easygen/shot0295.jpg)
