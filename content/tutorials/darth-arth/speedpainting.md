...
*   ![image]({static}speedpainting/_burn_swyl.png) Das Burn Tool ( dt. = Nachbelichter )
*   ![image]({static}speedpainting/_dodge_vscy.png) Das Dodge Tool ( dt. = Abwedler )
...
![image]({static}speedpainting/_newdoc_t745.png)
...
![image]({static}speedpainting/_schritt1_mdzq.png)
...
![image]({static}speedpainting/_schritt2_f8pk.png)

Nun sollten Details kommen, die etwas mehr decken, wie Kratzer, Risse oder Maserungen, welche den Objekten Festigkeit geben. 

Um das zu erreichen, erstellt einen neuen Layer ( dt. = Ebene ) und zeichnet die Details in Grautönen mit dem Brush Tool auf den neuen Layer. Zoomt ![image]({static}speedpainting/_zoom_7n6y.png) dazu am besten etwas näher an euer Objekt ran. 
...
![image]({static}speedpainting/_schritt3_ppyc.png)
...
![image]({static}speedpainting/_schritt4_hfu5.png)
...
![image]({static}speedpainting/_schritt5_w6qx.png)
...
![image]({static}speedpainting/_final_0t6q.png)
