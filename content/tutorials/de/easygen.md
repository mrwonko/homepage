...
*   [EasyGen]({filename}easygen/EasyGen_v142.zip)
...
![image]({filename}easygen/prefs.gif)
...
![image]({filename}easygen/Image33.gif)
...
![image]({filename}easygen/Image28.gif)
...
![image]({filename}easygen/Image13.gif)
...
![image]({filename}easygen/Image24.gif) ![image]({filename}easygen/Image25.gif)

Mit der Taste <kbd>Strg</kbd> und der rechten Maustaste kannst du die Höhe des Modifikators ändern.

![image]({filename}easygen/Image26.gif) ![image]({filename}easygen/Image27.gif)
...
![image]({filename}easygen/Image2.gif)

Geh ins Menü und wähle `File > save`.

![image]({filename}easygen/Image23.gif)
...
![image]({filename}easygen/Image17.gif)
...
![image]({filename}easygen/Image20.gif)
...
![image]({filename}easygen/Image19.gif)
...
![image]({filename}easygen/gtk/Image25.gif)
...
![image]({filename}easygen/gtk/Image28.gif)

Gehe ins Menü und wähle `Textures > Find/Replace` (Suchen/Ersetzen).

![image]({filename}easygen/gtk/Image24.gif)

Klicke jetzt mit der Maus in das obere Eingabefeld `Find`, 

![image]({filename}easygen/gtk/Image5.gif)

dann im Texturen-Fenster auf den roten Shader `caulk` ![image]({filename}easygen/gtk/Image26.gif).

`textures/common/caulk` erscheint unter `Find` (Suche)

![image]({filename}easygen/gtk/Image6.gif)

Jetzt klicke mit der Maus in das untere Eingabefeld,

![image]({filename}easygen/gtk/Image7.gif)

und dann in dem Texturenfenster auf den lila Shader `caulk` ![image]({filename}easygen/gtk/Image27.gif).

In unterem Eingabefeld erscheint `textures/system/caulk`.

![image]({filename}easygen/gtk/Image8.gif)

Um den Q3-Shader durch den richtigen zu ersetzen, klicke jetzt auf `Apply`.

![image]({filename}easygen/gtk/Image10.gif)
...
![image]({filename}easygen/gtk/Image23.gif)

Jetzt ist unsere Skybox mit der richtigen Caulk-Textur belegt.

![image]({filename}easygen/gtk/Image22.gif)
...
![image]({filename}easygen/gtk/Image21.gif)

Geh jetzt ins Menü und lade die Skies-Texturen  ( `Textures > Skies` )

Suche dann einen Sky-Shader mit dem Namen `Yavin` ![image]({filename}easygen/gtk/Image20.gif) und klicke ihn an.

![image]({filename}easygen/gtk/Image19.gif)
...
![image]({filename}easygen/gtk/Image18.gif)
...
![image]({filename}easygen/gtk/Image16.gif)![image]({filename}easygen/gtk/Image17.gif)
...
![image]({filename}easygen/shot0295.jpg)
